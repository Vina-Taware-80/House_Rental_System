...
if (isset($_POST['add_property'])) {
    ...
    mysqli_query($conn, "INSERT INTO properties (landlord_id, title, description, location, price, contact_number, image, status) 
...
<body>
    ...
    <div class="sidebar">
        ...
        <button>
            ...
            <a href="landlord_profile.php" style="color: white; text-decoration: none; font-size: 16px;">Update Profile</a>
        </button>

         <button>
             <i style="color: white;">🚪</i>
               <a href="Home_Page.php" style="color: white; text-decoration: none; font-size: 16px;">Logout</a>
              </button>
